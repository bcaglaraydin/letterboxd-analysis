        ...
        <div className="flex flex-col items-center justify-center w-full min-h-screen p-6 text-center">
          ...
          >
            <motion.h2
              ...
              className="text-3xl md:text-5xl font-serif text-primary mb-16 leading-relaxed tracking-tight"
            >
            ...
            >
              <Button
                ...
                className="px-20 py-8 h-auto text-xl font-bold tracking-[0.2em] uppercase rounded-2xl shadow-2xl hover:scale-105 transition-all bg-primary text-primary-foreground group"
              >
        ...
        >
          <div className="mb-16 text-center">
            <motion.div
              ...
              className="w-20 h-20 bg-primary/10 rounded-2xl flex items-center justify-center mx-auto mb-8 border border-primary/20 rotate-3 shadow-inner"
            >
            ...
            <motion.h2
              ...
              className="text-5xl md:text-7xl font-serif font-black text-primary leading-tight mb-6 tracking-tight"
            >
              Taste Soulmates
            </motion.h2>
            ...
            <motion.p
              ...
              className="text-xl md:text-2xl text-muted-foreground max-w-2xl mx-auto font-serif italic"
            >
              These members share {matchCount} of your top favorite films.
              <br />
              <span className="text-base not-italic font-sans font-medium tracking-wide uppercase opacity-50 mt-4 block">
                Kindred Spirits in Cinema
              </span>
            </motion.p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 w-full mb-20">
            <AnimatePresence>
              {matches.map((match, i) => (
                <motion.a
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 text-left">
                    <h3 className="font-bold text-xl text-primary truncate group-hover:text-accent transition-colors">
                      {match.name}
                    </h3>
                    <p className="text-sm text-muted-foreground font-medium tracking-tight truncate opacity-60 group-hover:opacity-100 transition-opacity">
                      @{match.url.replace(/\//g, '')}
                    </p>
                  </div>
                  <div className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center group-hover:bg-primary/20 transition-colors">
                    <ExternalLink className="w-5 h-5 text-muted-foreground group-hover:text-primary transition-all" />
                  </div>
                </motion.a>
              ))}
            </AnimatePresence>
          ...
          >
            <Button
              onClick={onComplete}
              size="lg"
              className="rounded-full px-16 py-10 text-2xl font-black gap-4 shadow-[0_20px_50px_rgba(0,0,0,0.2)] hover:scale-105 hover:-translate-y-1 transition-all group border-b-4 border-primary-foreground/20 active:border-b-0 active:translate-y-1"
            >
